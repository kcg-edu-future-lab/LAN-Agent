...
.\IncrementVersion-cs.ps1 ..\LanAgentConsole\WlcAgentConsole
...
.\CreateZipForAssembly-cs.ps1 ..\LanAgentConsole\WlcAgentConsole\bin\Release\WlcAgentConsole.exe ..\Downloads
